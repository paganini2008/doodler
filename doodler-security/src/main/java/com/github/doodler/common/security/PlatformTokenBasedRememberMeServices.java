...
public class PlatformTokenBasedRememberMeServices extends AbstractRememberMeServices {
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        UserDetails userDetails = ((PlatformUserDetailsService) getUserDetailsService()).loadUserByUsernameAndPlatform(
                cookieTokens[0], platform);
        ...
        // be cancelled.
        String expectedTokenSignature = makeTokenSignature(platform, tokenExpiryTime, userDetails.getUsername());
    ...
    public void onLoginSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        setCookie(new String[]{username, Long.toString(expiryTime), signatureValue, platform}, tokenLifetime, request,
                response);
