...
import static io.doodler.security.SecurityConstants.FACEBOOK_API_URI;
import static io.doodler.security.SecurityConstants.GOOGLE_API_URI;
import static io.doodler.security.SecurityConstants.LINE_API_URI;
import static io.doodler.security.SecurityConstants.LOGIN_AUTHENTICATOR;
import static io.doodler.security.SecurityConstants.MULTIPLE_LOGIN_AUTHENTICATOR;
import static io.doodler.security.SecurityConstants.REMEMBER_ME_KEY;
import static io.doodler.security.SecurityConstants.TWITCH_API_URI;
...
import io.doodler.security.facebook.FacebookAuthenticationProvider;
import io.doodler.security.facebook.FacebookClientApiService;
import io.doodler.security.google.GoogleAuthenticationProvider;
import io.doodler.security.google.GoogleClientApiService;
import io.doodler.security.line.LineAuthenticationProvider;
import io.doodler.security.line.LineClientApiService;
import io.doodler.security.totp.TotpAuthenticationProvider;
import io.doodler.security.twitch.TwitchAuthenticationProvider;
import io.doodler.security.twitch.TwitchClientApiService;
