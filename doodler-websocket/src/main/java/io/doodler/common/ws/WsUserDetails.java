...
import io.doodler.common.security.SecurityConstants;
import io.doodler.common.security.SecurityUtils;
...
public class WsUserDetails implements IdentifiableUserDetails {
    ...
    public WsUserDetails(IdentifiableUserDetails identifiableUserDetails) {
        ...
        this.authorities = CollectionUtils.isNotEmpty(identifiableUserDetails.getAuthorities()) ?
                SecurityUtils.getSimpleAuthorities(identifiableUserDetails.getAuthorities()) : Collections.emptyList();
        this.attributes = identifiableUserDetails.getAttributes();
    }

    public WsUserDetails(Long id, String username, String password, boolean enabled, String platform,
        ...
        this.authorities = CollectionUtils.isNotEmpty(authorities) ?
                SecurityUtils.getSimpleAuthorities(authorities) : Collections.emptyList();
    }
