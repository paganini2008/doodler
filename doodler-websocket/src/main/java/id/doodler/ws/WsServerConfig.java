...
import id.doodler.ws.handler.ChannelWsHandler;
import id.doodler.ws.handler.SessionContext;
import id.doodler.ws.handler.UserChannelWsHandler;
import id.doodler.ws.handler.UserSessionContext;
import id.doodler.ws.newsletter.SimpleWsMessageService;
import id.doodler.ws.security.WsUserSecurityCustomizer;
...
import io.doodler.redis.RedisCounterUtils;
...
public class WsServerConfig {
    ...
    @Bean
    public OnlineNumberAccumulator onlineNumberAccumulator(RedisConnectionFactory redisConnectionFactory) {
        ...
        RedisAtomicInteger chatCounter = RedisCounterUtils.getRedisIntegerCounter("online-number:chat",
                redisConnectionFactory, 0);
        return new OnlineNumberAccumulator(websiteCounter, userCounter, chatCounter);
    }
