...
import static com.github.doodler.common.Constants.DEFAULT_DATE_PATTERN;
import static com.github.doodler.common.Constants.ISO8601_DATE_TIME_PATTERN;
import static com.github.doodler.common.Constants.SUPPORTED_DATE_TIME_PATTERNS;
...
public abstract class JacksonUtils {
    ...
    public static SimpleModule getJavaTimeModuleForWebMvc() {
        ...
        simpleModule.addDeserializer(Date.class,
                new EnhancedDateDeserializer(SUPPORTED_DATE_TIME_PATTERNS));
        simpleModule.addDeserializer(Timestamp.class,
                new EnhancedTimestampDeserializer(SUPPORTED_DATE_TIME_PATTERNS));
        simpleModule.addDeserializer(Calendar.class,
                new EnhancedCalendarDeserializer(SUPPORTED_DATE_TIME_PATTERNS));
        simpleModule.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(
                DateTimeFormatter.ofPattern(ISO8601_DATE_TIME_PATTERN)));
        simpleModule.addDeserializer(LocalDateTime.class,
                new EnhancedLocalDateTimeDeserializer(SUPPORTED_DATE_TIME_PATTERNS));
        ...
        simpleModule.addDeserializer(LocalTime.class,
                new EnhancedLocalTimeDeserializer(SUPPORTED_DATE_TIME_PATTERNS));
