...
public abstract class SecurityConstants {
    ...
    public static final String MULTIPLE_LOGIN_AUTHENTICATOR = "my-user-service";
    ...
    public static final String PLATFORM_ADMIN = "backoffice";
    ...
    public static final String CLAIM_ADDITIONAL_INFORMATION = "additionalInformation";
