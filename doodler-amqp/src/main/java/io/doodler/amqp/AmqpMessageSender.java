...
import static io.doodler.amqp.AmqpConstants.AMQP_HEADER_EVENT_SENDER;
import static io.doodler.amqp.AmqpConstants.AMQP_HEADER_EVENT_TYPE;
import static io.doodler.amqp.AmqpConstants.DEFAULT_DEADLETTER_MESSAGE_EXPIRATION;
import static io.doodler.amqp.AmqpConstants.DEFAULT_FANOUT_EXCHANGE_NAME;
...
import io.doodler.common.enums.EventType;
...
public class AmqpMessageSender {
    ...
    public void convertAndSend(final EventType eventType, final Object payload) {
        ...
        convertAndSend(exchange, routingKey, payload, message -> {
            ...
            messageHistoryCollector.push(eventType.name(), payload);
