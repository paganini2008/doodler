...
import static io.doodler.common.amqp.AmqpConstants.AMQP_HEADER_CONSUMER_MAX_RETRIES;
import static io.doodler.common.amqp.AmqpConstants.DEFAULT_MAX_CONSUMER_RETRIES;
...
public final class EventContext {
    ...
    public void reject() throws IOException {
        ...
        try {
            channel.basicReject(getMessageProperties().getDeliveryTag(), requeue);
        } finally {
            if (!requeue) {
