...
public class SwaggerResourceProperties {
    ...
    private String title = "Spring Boot API Documentation";
    private String description = "Spring Boot API Documentation";
    ...
    public static class Contact {
        ...
        private String url = "";
        private String email = "fred.feng.work@gmail.com";
    }
