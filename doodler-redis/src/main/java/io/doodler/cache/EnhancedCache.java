...
/**
 * @Description: EnhancedCache
 * @Author: Fred Feng
 * @Date: 31/01/2023
 * @Version 1.0.0
 */
public class EnhancedCache implements InvocationHandler {
    ...
    EnhancedCache(String cacheName, Cache cache, CacheMethodFilter cacheMethodFilter) {
    ...
    public static Cache createProxy(String cacheName, Cache cacheObject,
        ...
        return (MockCache) Proxy.newProxyInstance(cacheObject.getClass().getClassLoader(),
                ...
                new EnhancedCache(cacheName, cacheObject, cacheMethodFilter));
    }
}