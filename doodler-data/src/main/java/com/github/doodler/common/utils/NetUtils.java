...
public abstract class NetUtils {
    ...
    private static final String[] PUBLIC_IP_FINDERS = new String[]{"http://checkip.amazonaws.com/",
    ...
    public static String getPublicIp() {
        return getPublicIp("localhost");
    }

    public static String getPublicIp(String defaultValue) {
        return getPublicIp(10000, defaultValue);
    }

    public static String getPublicIp(int timeout, String defaultValue) {
