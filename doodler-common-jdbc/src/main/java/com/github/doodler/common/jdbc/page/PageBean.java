...
public class PageBean<T> implements Serializable, Cloneable {
    ...
    private static final long serialVersionUID = 8924353929942721285L;
    ...
    public void refresh() {
        ...
        if (this.totalPages < this.showPages) {
            ...
            commonEnd = (commonBegin + this.showPages - 1) > this.totalPages ? this.totalPages
                    : (commonBegin + this.showPages - 1);
    ...
    public static <T> PageBean<T> wrap(PageResponse<T> pageResponse) throws SQLException {
        ...
        pageBean.setRows((int) pageResponse.getTotalRecords());
        pageBean.refresh();
        pageBean.setResults(pageResponse.getContent().getContent());
        return pageBean;
    }
    ...
    public Object clone() {
        try {
            ...
            pageBean.setResults(Collections.emptyList());
            return pageBean;
