...
public class RedisCacheStatisticsEndpoint {
    ...
    public ApiResult<CacheSample> sampler(@RequestParam("catelog") String catelog,
        ...
        Sampler<CacheSample> sampler = statisticsService.sampler(catelog, dimension, System.currentTimeMillis());
    ...
    public ApiResult<Map<String, Object>> sequence(@RequestParam("catelog") String catelog,
                                                   @RequestParam("dimension") String dimension) {
        Map<String, Object> data = statisticsService.sequence(catelog, dimension, false);
        return ApiResult.ok(data);
    }

    @GetMapping("/summarizeAll")
    public ApiResult<Map<String, CacheSample>> summarizeAll(@RequestParam("catelog") String catelog) {
